          ...
          for (let i = 0; i < data.length; i++) {
            if (data[i].status === "booked") {
              row =
                ...
                data[i].room_number +
                "</td>" +
                "<td style='background-color: grey;' id='row2seat" +
                i +
                "'>" +
                data[i].seat_number +
                "</td>" +
                "<td style='background-color: grey;' id='row3date" +
                i +
                "'>" +
                data[i].date +
                "</td>" +
                "<td style='background-color: grey;' id='row4time" +
                i +
                "'>" +
                "<span id='row31" +
                i +
                ...
                data[i].end_time +
                "</td>" +
                "<td style='background-color: grey;' id='row5seatCap" +
                i +
                "'>" +
